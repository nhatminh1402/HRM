                    ...
                    <div class="row">
                        @if (!empty($leave))
                            ...
                            <p>Tôi cam đoan sẽ hoàn thành tất cả các công việc
                                trước khi nghỉ và chắc chắn rằng không gây ảnh hưởng đến sự hoạt động của công ty/đơn vị.
                            </p>
                            <p>Tôi đã thông báo về việc nghỉ này cho đồng nghiệp và tôi sẽ cung cấp mọi thông tin cần thiết
                                để đảm bảo
                                sự
                                liên
                                tục trong công việc.</p>
                            <p>Tôi xin chân thành cảm ơn sự đồng thuận và sự chấp thuận của bạn. Mong nhận được sự phê duyệt
                                từ phía quý
                                công
                                ty/đơn vị.</p>
                            <p>Trân trọng,</p>
