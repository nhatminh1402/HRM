...
@section('breadcrumb-item-after', 'Danh sách khen thưởng')
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">DANH SÁCH KHEN THƯỞNG</h6>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        NỘI DUNG KHEN THƯỞNG</th>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        TÊN NHÂN VIÊN</th>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        NGÀY QUYẾT RA QUYẾT ĐỊNH</th>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        NGÀY NHẬN KHEN THƯỞNG</th>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        SỐ TIỀN</th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <h6 class="mb-0">1.000.000 vnd</h6>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        <h6 class="mb-0">1.500.000 vnd</h6>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
