...
@section('content')
    <h2 class="mt-3 mb-4 pb-2 border-bottom text-primary">Danh sách tài khoản </h2>
    <div class="col-12 mb-4">
        <div class="card border-0 shadow w-100">
            <div class="d-flex justify-content-end mb-2">
                <form class="navbar-search position-relative w-30" id="navbar-search-main" action="{{ route('admin.employee.search-employee') }}" method="GET">
                    <div class="input-group input-group-merge search-bar">
                        ...
                        <input type="text" name="key" value="{{ request('key') }}" class="form-control" id="topbarInputIconLeft" placeholder="Search" aria-label="Search" aria-describedby="topbar-addon">
                    </div>
                </form>
            </div>
        </div>
