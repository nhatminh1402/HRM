    ...
    <div class="row ml-4">
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h3 class="h3 mb-3 mt-3">Danh sách chức vụ </h3>
                        ...
                        @else
                            @foreach ($positions as $key => $position)
                                <tr>
                                    ...
                                    <td class='align-middle text-start'>{{ $position->name }}</td>
                                    <td class='align-middle text-start'>{{ e($position->description ?? 'Chưa có mô tả') }}</td>
                                    <td class='align-middle text-start'>{{ date('d/m/Y', strtotime($position->created_at)) }}</td>
                                    <td class='align-middle text-start'>{{ date('d/m/Y', strtotime($position->updated_at)) }}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-position" action="{{ route('admin.employee.positions.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
