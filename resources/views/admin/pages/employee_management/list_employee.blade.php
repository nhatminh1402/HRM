        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-2">
                <div class="mb-3">
                    ...
                    <a href="{{ route('admin.employee.create-employee') }}" class="btn btn-primary">
                        <svg class="mb-1" xmlns="http://www.w3.org/2000/svg" height="16" width="14"
                            viewBox="0 0 448 512">
                            <path
                    ...
                    <a href="/admin/employees/export?keySearch={{ request('key') }}">
                        <button type="button" class="btn btn-success text-white">
                            <svg class="icon icon-xxs" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
                ...
                <form class="navbar-search w-10" id="navbar-search-main"
                    action="{{ route('admin.employee.search-employee') }}" method="GET">
                ...
                <table class="table table-bordered table-centered ">
                    <thead class="border">
                        <tr class="table border">
                            ...
                            <th class="text-center rounded-end">Thao tác</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if (!empty($employees))
                            @foreach ($employees as $key => $employee)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn border-0 btn-update">
