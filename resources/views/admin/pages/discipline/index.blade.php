...
@section('content')
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <form class="navbar-search w-25 mb-4" id="navbar-search-main" action="{{route('admin.discipline.search')}}" method="GET">
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <form id="form-delete-discipline"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger btn-delete-discipline"><svg xmlns="http://www.w3.org/2000/svg"
