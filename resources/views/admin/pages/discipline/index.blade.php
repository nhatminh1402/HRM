...
@section('content')
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h3 class="h3 mb-3 mt-3">Danh sách loại kỷ luật </h3>
                    ...
                    @else
                        @foreach ($disciplines as $key => $discipline)
                            <tr>
                                ...
                                <td class='text-center'>{{ e($discipline->description ?? 'Chưa có mô tả') }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.discipline.store') }}" method="POST" class="mb-4">
                        <div class="row ml-4">
                            @csrf
                            <input type="text" class="form-control d-none" name="code_discipline" id="code_discipline"
