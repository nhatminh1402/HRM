                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <a class="btn btn-warning"
                                        href="{{ route('admin.project.edit-project', ['id' => $project->id, 'page' => $pageNumber]) }}">
                                ...
                                <td class='text-center'>
                                    <form id="form-delete" action="{{ route('admin.project.destroy', $project->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger btn-delete"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.project.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="code_project" class="form-label mb-2 font-weight-bold">Mã dự án:</label>
                        ...
                        <div class="mb-3 d-flex flex-column">
                            <label for="tags" class="form-label form-control-sm font-weight-bold">Chọn nhân
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="5" cols="50">{{ strip_tags(old('description')) }}</textarea>
                        </div>
                    </form>
                </div>
