                                ...
                                <tr>
                                    ...
                                    <td class='text-center'>
                                        <h6 style="margin-left: 20px" class="mb-0">
                                            @if ($leave->status == 0)
                                                <span class="rounded bg-warning text-white small font-weight-bold p-1">Đang
                                                    chờ</span>
                                            @elseif ($leave->status == 1)
                                                <span class="rounded bg-success text-white small font-weight-bold p-1">Đã
                                                    duyệt</span>
                                            @elseif ($leave->status == 2)
                                                <span class="rounded bg-danger text-white small font-weight-bold p-1">Không
                                                    duyệt</span>
                                            @endif
                                        </h6>
                                    </td>
                                    <td class='text-center'>
                                        <a class="btn border-0" href="{{ route('admin.leave.detail', $leave->id) }}">
